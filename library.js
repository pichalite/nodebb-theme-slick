...
library.init = async function (params) {
	...
	routeHelpers.setupAdminPageRoute(router, '/admin/plugins/vtubeando', [], controllers.renderAdminPage);
...
library.removeFinalBreadcrumb = async (hookData) => {
	...
	// Remove the last breadcrumb (the current page) as it is not part of vtubeando's design
