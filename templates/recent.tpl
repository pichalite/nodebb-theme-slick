<div class="recent">
	...
	<div class="btn-toolbar">
		...
		<div class="btn-group pull-right bottom-sheet <!-- IF !categories.length -->hidden<!-- ENDIF !categories.length -->">
